...
export default function anglesController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'angles.c';
  ...
  // Set image path
  // $scope.anglesImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
