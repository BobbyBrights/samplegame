...
export default function sideCornersController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'side-corners.d';
  ...
  // Set image path
  // $scope.sideCornersImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
