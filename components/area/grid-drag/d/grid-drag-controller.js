...
export default function gridDragController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'grid-drag.d';
  ...
  // Set image path
  // $scope.gridDragImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
