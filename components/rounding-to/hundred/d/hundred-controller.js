...
export default function hundredController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'hundred.d';
  ...
  // Set image path
  // $scope.hundredImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
