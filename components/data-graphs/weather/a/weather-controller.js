export default function weatherController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'weather.a';

  var gameData = GameData.getCamelCase('levels.' + $scope.level + '.categories.' +
    $stateParams.category + '.games.data-graphs.types.weather');
  ...
  $scope.iconImages = RequireImages.get($scope.getImageContext(), questionData.weatherImages);
