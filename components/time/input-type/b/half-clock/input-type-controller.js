export default function inputTypeController($scope, $state, $stateParams, GameData, RequireImages, $timeout) {
  ...
  $scope.gamePageView = 'half-clock.b';

  var gameData = GameData.getCamelCase('levels.' + $scope.level + '.categories.' +
    $stateParams.category + '.games.time.types.half-clock');
  ...
  function rotateNeedle() {
    ...
    angular.element('#hour-needle').css('transform', 'rotate(' + (degree + 15) + 'deg)');
    var time = ((degree + 15) / rotateBy);
