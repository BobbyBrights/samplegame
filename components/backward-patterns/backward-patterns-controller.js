...
export default function backwardPatternsController($scope, $stateParams, $timeout,$interval, GameData, RequireImages) {
  'ngInject';

  var gameData = GameData.getCurrentGame();

  $scope.category = $stateParams.category;
  $scope.gameName = $stateParams.game || 'backward-patterns';
