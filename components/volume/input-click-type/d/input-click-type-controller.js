...
export default function inputClickTypeController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'input-click-type.d';
  ...
  // Set image path
  // $scope.inputClickTypeImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
