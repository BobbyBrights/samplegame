...
export default function circlesController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'circles.c';
  ...
  // Set image path
  // $scope.circlesImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
