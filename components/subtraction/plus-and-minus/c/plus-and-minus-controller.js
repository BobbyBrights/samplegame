...
export default function plusAndMinusController($scope, $state, $stateParams, GameData, RequireImages) {
  'ngInject';

  $scope.gamePageView = 'plus-and-minus.c';
  ...
  // Set image path
  // $scope.plusAndMinusImages = RequireImages.get($scope.getImageContext(), gameData.home.images);
